/-
  ...
  (a typeclass-level derivation). The generic resultant bridge is now
  theorem-backed directly; this differential bridge remains available
  for Galois norm/trace formulations such as
