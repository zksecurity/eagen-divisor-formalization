...
Number of zeros of a non-trivial CoordRingElt on E ≤ degE.
    ...
    • deg N ≤ degE.
    So #zeros ≤ 2·#{roots of N} ≤ 2·deg N... but this gives 2·degE, too loose.
    Instead, use multiplicity: at each common root of a and b,
...
lemma curve_eval_zeros_le_zero
  ...
  -- Since $g$ is a constant polynomial, we can write it as $g = c$ for some $c \in \mathbb{F}_q$.
